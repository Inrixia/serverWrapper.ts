...
// 					module: thisModule,
// 					description: {
// 						console: `whiteStarts a backup. }Example: yellow~backup}`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteStarts automatic backups. }Example: yellow~startBackupInterval}`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteStops automatic backups. }Example: yellow~clearBackupInterval}`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteSets backup interval in hours. }Example: yellow~setBackupInterval ${sS.c["blueBright"].c}1}`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteGets backup directory. }Example: yellow~backupDir}`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteGets time to next backup. }Example: yellow~nextBackup}`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteGets last backup info. }Example: yellow~lastBackup}`,
// 						minecraft: [
// 							{
...
// 		return {
// 			console: `${sS.c[sS.modules["backup"].color].c}Automatic backup's started!} Next backup in ${moment(timeToNextBackup).fromNow()}`,
...
// 		await pushStats();
// 		return {
// 			console: `${sS.c[sS.modules["backup"].color].c}Automatic backup's stopped!}`,
// 			minecraft: `tellraw ${message.logTo.user} ${JSON.stringify({
...
// 				},
// 			},
// 			console: `Saving backups in: ${sS.c[sS.modules["backup"].color].c}${backupDir}}`,
// 			minecraft: `tellraw ${message.logTo.user} ${JSON.stringify([
// 				{
...
// 			console: `${
// 				timeToNextBackup
// 					? `${sS.c[sS.modules["backup"].color].c}Next backup ${moment(timeToNextBackup).fromNow()}`
// 					: `${sS.c[sS.modules["backup"].color].c}Backups disabled...`
// 			}}`,
// 			minecraft: `tellraw ${message.logTo.user} ${JSON.stringify([
// 				{
...
// 			console: `${
// 				lastBackupStartTime
// 					? `Last backup happened ${sS.c[sS.modules["backup"].color].c}${moment(lastBackupStartTime).fromNow()}`
// 					: `${sS.c[sS.modules["backup"].color].c}No backup has occoured yet...`
// 			}}`,
// 			minecraft: `tellraw ${message.logTo.user} ${JSON.stringify([
// 				{
...
// 	await util.pExec(
// 		`rsync-snapshot --src ${sS.server_dir} --shell "ssh -p ${mS.remote.port}" --dst ${mS.remote.user}@${mS.remote.ip}:${backupDir} ${excludes} --maxSnapshots ${mS.maxBackups}`,
