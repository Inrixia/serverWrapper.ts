...
// 					module: thisModule,
// 					description: {
// 						console: `whiteTeleports player to given chunk coords. }\nExample: yellow~tpc ${sS.c["orange"].c}10 ${sS.c["blueBright"].c}10 }tp's to ${sS.c["orange"].c}160 white100 ${sS.c["blueBright"].c}160 }`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteTeleports player to given region coords. }\nExample: yellow~tpr ${sS.c["orange"].c}10 ${sS.c["blueBright"].c}10 whitetp's to ${sS.c["orange"].c}5120 white100 ${sS.c["blueBright"].c}5120 }`,
// 						minecraft: [
// 							{
...
// 					module: thisModule,
// 					description: {
// 						console: `whiteExit the server with a timer and a optional reason. }\nExample: yellow~exit ${sS.c["orange"].c}10 ${sS.c["blueBright"].c}"Server restart" "applying config changes"`,
// 						minecraft: [
// 							{
...
// 										name: "Result",
// 										value:
// 											"**$serverGoingTo in x seconds! Reason: $serverExitReason** as title for all players, time updates every second. **$serverKickReason** is reason why players are kicked at end of countdown.",
// 									},
// 								],
// 							},
// 						},
...
// 							},
// 						},
// 						console: `yellowExit is active, please cancel it with ~exit cancel first }`,
// 					};
// 				}
// 			} else {
// 				return {
...
// 						},
// 					},
// 					console: `${sS.c["green"].c}Exit cancelled }`,
// 				};
// 			}
// 		}
...
// 									"serverWrapper",
// 									"serverStdin",
// 									`title @a actionbar ["",{"text":"${serverGoingTo} in ${time} seconds, reason: ${serverExitReason}","color":"dark_red","bold":true}]:"\n`
// 								)
// 								.catch((err) => modul.lErr(err, "Sending server restart interval message failed"));
// 							--time;
// 						}, 1000); // run the code in brackets every x ms
// 						let timeout = setTimeout(
// 							async (serverKickReason) => {
...
// 									"serverWrapper",
// 									"serverStdin",
// 									'say Server exit was cancelled!\ntitle @a actionbar ["",{"text":"Server exit cancelled!","color":"dark_red","bold":true}]:"\n'
// 								);
// 							}
// 							modul
// 								.call("serverWrapper", "serverStdin", `title @a actionbar ["",{"text":"Server stopping in ${time} seconds","color":"dark_red","bold":true}]:"\n`)
// 								.catch((err) => modul.lErr(err, "Sending server restart interval message failed"));
// 							--time;
// 						}, 1000); // run the code in brackets every x ms
// 						let timeout = setTimeout(
...
// 			await Promise.all(
// 				pingTable.players.sample.map((player) => {
